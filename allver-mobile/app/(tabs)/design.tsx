...
const mapBackendPostToDesign = (bp: any): DesignItem => {
  ...
  return {
    ...
    rating: bp.creator?.rating || 0,
    authorName: bp.creator?.fullName || 'Architect',
    authorAvatar: bp.creator?.avatarUrl || '',
    authorId: bp.creator?._id || '',
    authorCover: bp.creator?.cover || '',
    authorFirm: bp.creator?.firmName || '',
    authorExperience: bp.creator?.experience || '',
    authorProjects: bp.creator?.projects?.toString() || '0',
    authorFollowers: bp.creator?.followersCount?.toString() || '0',
    authorPhone: bp.creator?.phoneNumber || '',
    authorReviews: bp.creator?.reviews?.toString() || '0',
